...
int main()
{
  ...
  // pid_steer.Init(0.2, 0.008, 5.5);
  pid_steer.Init(0.06, 0.002, 2.0);
  // Throttle should not depend on the cumulative error.
  pid_throttle.Init(0.75, 0.0, 3.0);
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Minim throttle of 0.1
          if (throttle_value > 0.9) {
            throttle_value = 0.9;
          }
